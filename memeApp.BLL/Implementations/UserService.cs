...
namespace memeApp.BLL.Implementations
{
    public class UserService: IUserService
    {
        ...
        {
            var find_id = await unitofWork.userRepository.Get(id);
            ...
            try
            {
                ...
                //{
                    ...
                    var add_User = new User
                    {
                        ...
                        userRoleRoleId = userDTO.RoleId

                    };
                    await unitofWork.userRepository.Post(add_User);
        ...
        {
            var find_User = await unitofWork.userRepository.Delete(id);
            if(find_User== null)
            {
        ...
        public async Task<ApiResponse> LoginUser(UserLoginDTO userLoginDTO)
        {
            ...
            List<Claim> Claims = new List<Claim>
            {
                ...
                new Claim(ClaimTypes.NameIdentifier, search_User.Id.ToString())
            };
